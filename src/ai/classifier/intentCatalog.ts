...
export const INTENT_CATALOG: IntentDefinition[] = [
  ...
  },
  {
    ...
    description: "code refactor refatorar reestruturar reorganize modularize maintainability split god file cleanup rewrite decouple extract module improve structure reduce duplication",
    examples: [
      "refactor god service",
      "split module responsibilities",
      "cleanup orchestration file",
      "refatorar meu codigo",
      "reestruturar modulo legado",
      "separar responsabilidades do service",
      "remover duplicacao do codigo",
